...
Figure~\ref{fig:authoritycontext} proves the "Insular Community Hypothesis". Both James Brown and Daniel Ingram receive most of their influence from inside their own community (74\% and 89\% respectively). The key difference is community scale: James Brown's community spans 2,196 artists (hip-hop/funk/soul --- the mainstream of modern music), while Daniel Ingram's is a tight-knit circle of \textasciitilde50\textendash100 My Little Pony fan remixers. PageRank amplifies authority inside dense clusters regardless of size --- the community context reveals whether that authority is global or insular.
